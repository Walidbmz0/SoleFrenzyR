    ...
    ";
        ...
        if ((twig_length_filter($this->env, (isset($context["basket"]) || array_key_exists("basket", $context) ? $context["basket"] : (function () { throw new RuntimeError('Variable "basket" does not exist.', 9, $this->source); })())) > 0)) {
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["item"]) {
                ...
                echo " €</p>
                                ...
                                <button class=\"btn btn-circle\">
                                    <a href=\"";
                // line 55
                echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("basket_remove", ["id" => twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["item"], "product", [], "any", false, false, false, 55), "id", [], "any", false, false, false, 55)]), "html", null, true);
                echo "\">
            ...
            echo "                Nombre de produit :
                ";
            // line 66
            echo twig_escape_filter($this->env, twig_length_filter($this->env, (isset($context["basket"]) || array_key_exists("basket", $context) ? $context["basket"] : (function () { throw new RuntimeError('Variable "basket" does not exist.', 66, $this->source); })())), "html", null, true);
            echo "
                <br>
            ...
            echo "\">Continuer mes achats</a>
                    <a class=\"btn btn-primary btn-sm\" href=\"#\">Valider mon panier</a>
...
";
    ...
    {
        return array (  235 => 93,  229 => 90,  223 => 86,  210 => 76,  203 => 72,  194 => 66,  191 => 65,  175 => 55,  168 => 51,  161 => 47,  156 => 45,  152 => 44,  143 => 38,  139 => 37,  133 => 34,  130 => 33,  127 => 32,  122 => 31,  120 => 30,  116 => 29,  95 => 10,  93 => 9,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
                          ...
                          <div class=\"sm:ml-4 sm:flex sm:w-full sm:justify-between\">
                            ...
                            <div class=\"mt-4 flex justify-between sm:space-y-6 sm:mt-0 sm:block sm:space-x-6\">
                              ...
                              <div class=\"flex items-center space-x-4\">
                                ...
                                <button class=\"btn btn-circle\">
                                    <a href=\"{{path ('basket_remove', {id: item.product.id})}}\">
                                    <svg xmlns=\"http://www.w3.org/2000/svg\" class=\"h-6 w-6\" fill=\"none\" viewBox=\"0 0 24 24\" stroke=\"currentColor\"><path stroke-linecap=\"round\" stroke-linejoin=\"round\" stroke-width=\"2\" d=\"M6 18L18 6M6 6l12 12\" /></svg>
                                  </button>
