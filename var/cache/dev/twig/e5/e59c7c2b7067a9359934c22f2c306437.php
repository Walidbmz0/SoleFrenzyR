...
{% block panel %}
    ...
    {% endif %}
{% endblock %}
", "@WebProfiler/Collector/cache.html.twig", "/Users/walidbelmezouar/Documents/prog/SoleFrenzy/vendor/symfony/web-profiler-bundle/Resources/views/Collector/cache.html.twig");
    }
}
