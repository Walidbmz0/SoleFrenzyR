...
<nav class=\"bg-white border-gray-200 dark:bg-pink-100 dark:border-gray-700\">
    <div class=\"max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4\">
      ...
      <div class=\"hidden w-full md:block md:w-auto\" id=\"navbar-dropdown\">
        <ul class=\"flex flex-col font-medium p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 md:mt-0 md:border-0 md:bg-white dark:bg-pink-800 md:dark:bg-pink-100 dark:border-gray-700\">
          <li>
            <a href=\"/\" class=\"block py-2 pl-3 pr-4 text-white bg-brown-700 rounded md:bg-transparent md:text-brown-700 md:p-0 md:dark:text-brown-500 dark:bg-brown-600 md:dark:bg-100\" aria-current=\"page\">Accueil</a>
          </li>
          <li>
