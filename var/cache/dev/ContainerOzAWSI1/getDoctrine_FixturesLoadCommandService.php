...
class getDoctrine_FixturesLoadCommandService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/src/DataFixtures/BrandFixtures.php';
        include_once \dirname(__DIR__, 4).'/src/DataFixtures/CategoryFixtures.php';
        include_once \dirname(__DIR__, 4).'/src/DataFixtures/ProductShopFixtures.php';
        ...
        $a->addFixtures([0 => ['fixture' => new \App\DataFixtures\AppFixtures(), 'groups' => []], 1 => ['fixture' => new \App\DataFixtures\BrandFixtures(), 'groups' => []], 2 => ['fixture' => new \App\DataFixtures\CategoryFixtures(), 'groups' => []], 3 => ['fixture' => new \App\DataFixtures\ProductShopFixtures(), 'groups' => []]]);
